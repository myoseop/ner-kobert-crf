...
from model.net_for_infer import KobertSequenceFeatureExtractor, KobertCRF, KobertBiLSTMCRF, KobertBiGRUCRF
...
def main(parser):
    ...
    #checkpoint = torch.load("./experiments/base_model_with_crf_val/best-epoch-15-step-750-acc-0.884.bin", map_location=torch.device('cpu'))
